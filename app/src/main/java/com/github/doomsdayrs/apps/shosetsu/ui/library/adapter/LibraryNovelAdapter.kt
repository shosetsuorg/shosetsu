 ...
 */
class LibraryNovelAdapter(private val novelCards: ArrayList<Int>, private val libraryController: LibraryController, @LayoutRes val layout: Int) : RecyclerView.Adapter<LibNovelViewHolder>() {
    ...
    override fun onBindViewHolder(libNovelViewHolder: LibNovelViewHolder, i: Int) {
        ...
        run {
            ...
            libNovelViewHolder.formatter = FormattersRepository.getByID(novelCard.formatterID)

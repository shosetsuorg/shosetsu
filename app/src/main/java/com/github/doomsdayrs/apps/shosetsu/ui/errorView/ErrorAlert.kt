 ...
 */
class ErrorAlert(context: Context, val retryAction: (dialog: DialogInterface?, which: Int) -> Unit = { dialog: DialogInterface?, which: Int -> dialog?.dismiss() }) : AlertDialog.Builder(context) {

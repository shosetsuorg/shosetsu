...
class NovelFragmentUpdate(private val novelFragmentInfo: NovelFragmentInfo) : OnRefreshListener {
    override fun onRefresh() {
        if (novelFragmentInfo.novelFragment != null && novelFragmentInfo.novelFragment!!.formatter != null) NovelLoader(novelFragmentInfo.novelFragment!!.novelURL, novelFragmentInfo.novelFragment!!.novelID, novelFragmentInfo.novelFragment!!.formatter, novelFragmentInfo.novelFragment, false)
                .execute()
    }

package com.github.doomsdayrs.apps.shosetsu.view.builder
...
open class SDViewBuilder(
	...
	private inline fun <A> wrap(crossinline body: (a: A) -> Unit): (a: A) ->
	SDViewBuilder = { body(it); this }

	private inline fun <A, B> wrap(crossinline body: (a: A, b: B) -> Unit): (a: A, b: B) ->
	SDViewBuilder = { a, b -> body(a, b); this }

	private inline fun <A, B, C> wrap(crossinline body: (a: A, b: B, c: C) -> Unit)
			: (a: A, b: B, c: C) -> SDViewBuilder = { a, b, c -> body(a, b, c); this }

package com.github.doomsdayrs.apps.shosetsu.newStruc.application
...
import com.github.doomsdayrs.apps.shosetsu.newStruc.viewmodel.factory.ViewModelFactory
...
class ShosetsuApplication : Application(), KodeinAware {
	...
	override val kodein: Kodein by Kodein.lazy {
		...
		bind<ShosetsuRoomDatabase>() with singleton {
			ShosetsuRoomDatabase.getRoomDatabase(applicationContext)
		}
